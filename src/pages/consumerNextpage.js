...
function ConsumerNextPage() {
  ...
  return (
    <>
      <div className="consumer-profile-main-container">
        {/* Heading container */}
        ...
        {/* switch button */}
        <div className="consumer-profile-switch-button-container">
          ...
          <form onSubmit={handleCreateAccount}>
            ...
            <div className="consumer-profile-pic-upload">
              ...
              <div className="key-image-upload-guidlines">
                <p>
                  Drag & drop or choose file to upload an image of yourself.
                </p>
                <p>
                  <strong>
            ...
            <div className="consumer-profile-name-address-row">
              <div className="consumer-profile-form-group">
                ...
                <input
                  ...
                  className="fullname consumer-profile-input-field"
                />
              </div>
              ...
              <div className="consumer-profile-form-group">
                ...
                <input
                  ...
                  className="consumer-profile-input-field"
                />
              </div>
            </div>
            ...
            <div className="consumer-profile-form-group">
              ...
              <textarea
                ...
                className="consumer-profile-textarea-input"
              />
            </div>
