...
import { FaPhone, FaEnvelope, FaMapMarkerAlt, FaBriefcase, FaMedal } from "react-icons/fa";
    ...
    <div className="profile-container">
      <div className="profile-header">
        ...
        <div className="profile-header-info">
          ...
          <p className="ratings" style={{ color: "gold" }}>{profileData.ratings}</p>
      ...
      <div className="profile-body">
        ...
        <div className="profile-section">
          <h2>Experience</h2>
          <p>
            <FaBriefcase className="icon" /> Completed Jobs: {profileData.completedJobs}
          </p>
        </div>
      </div>
